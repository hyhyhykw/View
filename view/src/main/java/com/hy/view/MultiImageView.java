...
import com.hy.view.utils.PicassoLoader;
import com.hy.view.utils.SizeUtils;
...
public class MultiImageView extends LinearLayout {
    ...
    public MultiImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        borderRadius = a.getDimensionPixelOffset(R.styleable.MultiImageView_miv_border_radius, SizeUtils.dp1() * 3);
        mSpacing = a.getDimensionPixelOffset(R.styleable.MultiImageView_miv_spacing, SizeUtils.dp1() * 5);
        mMaxHeight = a.getDimensionPixelOffset(R.styleable.MultiImageView_miv_max_height, SizeUtils.dp1() * 212);
        int left = a.getDimensionPixelOffset(R.styleable.MultiImageView_miv_left,SizeUtils.dp1() * 16);
        int right = a.getDimensionPixelOffset(R.styleable.MultiImageView_miv_right, SizeUtils.dp1() * 16);
        ...
        imageSize = (int) ((Base.getScreenWidth() - left - right - mSpacing * 2f) / 3);
    }
            ...
            ImageLoader.getInstance().displayImage(mImages.get(0), roundImageView, displayImageOptions, new ImageLoadingListener() {
                ...
                public void onLoadingComplete(String imageUri, View view, Bitmap bitmap) {
                    ...
                    if (h > mMaxHeight) {
                        ...
                        oneWidth = w;
                        if (oneWidth > Base.getScreenWidth() * 2 / 3f) {
                            oneWidth = (int) (Base.getScreenWidth() * 2 / 3f);
                        }
