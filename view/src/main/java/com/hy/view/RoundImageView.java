...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        borderRadius = (int) array.getDimension(R.styleable.RoundImageView_riv_borderRadius, BODER_RADIUS_DEFAULT);
        type = array.getInt(R.styleable.RoundImageView_riv_type, TYPE_NORMAL);
        border_width = (int) array.getDimension(R.styleable.RoundImageView_riv_borderWidth, BORDER_WIDTH);
        border_color = array.getColor(R.styleable.RoundImageView_riv_borderColor, BORDER_COLOR);
        array.recycle();
    }
